...
‘solver3_medium.py’ - Randomly partitions the input graph 500 times, selects the best-scoring random partition as a starting point, then uses a modified simulating annealing algorithm with 1000 iterations to improve upon this approximation.

‘solver3_small.py’ - Randomly partitions the input graph 100 times, selects the best-scoring random partition as a starting point, then uses a modified simulating annealing algorithm with 800 iterations to improve upon this approximation.
